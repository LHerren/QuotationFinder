...
# Version History:
# 0955:
# Replaced deprecated method of handling multi-file uploads.
# 095:
...
END
  ...
  <tr> 
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Login" target="Help">Help&nbsp;</a></td>
...
END
  ...
  <tr> 
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Search_Text_Name" target="Help">Help&nbsp;</a></td>
...
#//				}
  ...
  <tr> 
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Search_Text" target="Help">Help&nbsp;</a></td>
    <td class=roman>
HTML
...
END
  ...
  <tr> 
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Add_Word" target="Help">Help&nbsp;</a></td>
    <td class=roman>
HTML
...
END
  ...
  <tr> 
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Fill_Fields" target="Help">Help&nbsp;</a></td>
    <td class=roman>
HTML
...
HTML
	if (@_ > 10 and $_[11] =~ /modify/) {								# Checks to see if @_ contains more than 10 items and the 12th item 
		...
		print <<HTML;
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Modify_Words" target="Help">Help&nbsp;</a></td>
HTML
																		...
																		# the code inside of the block. 
		print <<HTML;
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Delete_Words" target="Help">Help&nbsp;</a></td>
HTML

	} 																	# Closes the if (@_ > 10) block; Nutshell 4.3.
	else {	
		print <<HTML;
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#View_Words" target="Help">Help&nbsp;</a></td>
HTML
...
#	error( $q, "uploadSize is $uploadSize" );							# For debugging
  ...
  <tr> 
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Results" target="Help">Help&nbsp;</a></td>
    <td class=roman>
...
<table width="750" border="0">
  <tr>
    ...
    <td width="588">
      ...
      <br>For further information click <a href="../QuotationFinderHelp.html#Search_Progress" target="Help">here</a>.
    </td>
  </tr>
</table>
HTML
...
//			if (file == "") {
////				alert("Please choose a file.");						// Under newer versions of Mac OS X / Perl / cgi.pm / JavaScript, this is being triggered
//				alert("Please choose a file. file is " + file);			// in multi-file mode even if files have been chosen. The problem seems to be that as there are 
//				return false;											// multiple file fields now, an array is returned rather than the variable the validation code  
//			}															// expects.
...
HTML
  ...
  <tr> 
    <td class=roman align="right"><a href="../QuotationFinderHelp.html#Choose_File" target="Help">Help&nbsp;</a></td>
    <td class=roman>
